...
const teacherData = [
  { key: 1, subject: "Toán học", date: "01/05/2025", room: "201", startTime: "08:00", endTime: "10:00" },
  { key: 2, subject: "Vật lý", date: "03/05/2025", room: "202", startTime: "10:00", endTime: "12:00" },
  { key: 3, subject: "Hóa học", date: "05/05/2025", room: "203", startTime: "14:00", endTime: "16:00" },
];

const teacherEvents = teacherData.map(item => ({
  date: item.date,
    ...
    <Layout style={{ minHeight: "100vh", background: "#f0f2f5" }}>
      <Header style={{ background: "#fff", padding: "0 16px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div style={{ display: "flex", alignItems: "center" }}>
          ...
          <Title level={4} style={{ margin: 0 }}>Phòng giám sát</Title>
        </div>
        <div style={{ display: "flex", alignItems: "center" }}>
          <Text style={{ fontSize: 16, marginRight: 16 }}>Xin chào, giảng viên</Text>
      ...
      <Content style={{ margin: "16px", padding: 24, background: "#fff" }}>
        <Tabs defaultActiveKey="table">
          ...
          <TabPane tab="Lịch tuần" key="week">
            <WeeklyCalendar events={teacherEvents} />
          </TabPane>
        </Tabs>
      </Content>
    </Layout>
